...
/**
 * DTO for resource recommendations
 * Contains information about recommended resources
 */
public class ResourceRecommendation {
    ...
    public ResourceRecommendation(String resourceId, String resourceName, String resourceType,
                                 String location, double recommendationScore, String reason) {
