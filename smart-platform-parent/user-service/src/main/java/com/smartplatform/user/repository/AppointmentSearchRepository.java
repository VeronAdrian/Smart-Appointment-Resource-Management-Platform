 ...
 */
@Repository
public interface AppointmentSearchRepository extends ElasticsearchRepository<AppointmentDocument, String> {
    
    /**
     * Find appointments by client username and tenant
     */
    List<AppointmentDocument> findByClientUsernameAndTenantId(String clientUsername, String tenantId);
     ...
     */
    List<AppointmentDocument> findByAppointmentTypeAndTenantId(String appointmentType, String tenantId);
    ...
    @Query("{\"bool\": {\"must\": [" +
            ...
            "{\"term\": {\"tenantId\": \"?2\"}}" +
            "]}}")
    List<AppointmentDocument> findByDateRangeAndTenant(LocalDateTime startDate, LocalDateTime endDate, String tenantId);
    ...
    @Query("{\"bool\": {\"must\": [" +
            ...
            "{\"term\": {\"tenantId\": \"?3\"}}" +
            "]}}")
    List<AppointmentDocument> findByStaffAndDateRange(String staffUsername, LocalDateTime startDate, 
