...
public class StaffAvailabilityView extends VerticalLayout implements BeforeEnterObserver {
    public StaffAvailabilityView(
            AvailabilityService availabilityService, TenantContext tenantContext) {
        ...
        Button createSlot =
                new Button(
                        ...
                        e -> {
                            ...
                            LocalTime endTime =
                                    LocalTime.of(
                                            endHour.getValue() != null ? endHour.getValue() : 10,
                            ...
                            AvailabilitySlot slot =
                                    availabilityService.createSlot(
                                            staffUsername, startDateTime, endDateTime, tenantId);
                            if (slot != null) {
