...
/**
 * Elasticsearch Index Synchronization Service. Handles bulk indexing of
 * appointments and resources
 * into Elasticsearch. Useful for initial setup and periodic re-indexing.
 */
@Service
public class IndexSyncService {
    ...
    /**
     * Synchronize all appointments to Elasticsearch. Called during application
     * startup.
     */
    ...
    public void initializeIndices() {
        try {
            ...
            System.err.println(
                    "Warning: Could not initialize Elasticsearch indices: " + e.getMessage());
        }
    }
    ...
    public void syncAllAppointments() {
        try {
            // Get all appointments from the application service. This is a simplified
            // version; adjust based on your AppointmentService implementation.
            ...
            if (!appointmentDocs.isEmpty()) {
                ...
                System.out.println(
                        "Successfully indexed " + appointmentDocs.size() + " appointments");
            }
        } catch (Exception e) {
    ...
    public void syncAllResources() {
        try {
            // Get all resources from the application service. This is a simplified version;
            // adjust based on your ResourceService implementation.
