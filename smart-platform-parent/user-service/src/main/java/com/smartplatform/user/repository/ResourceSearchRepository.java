...
public interface ResourceSearchRepository
        extends ElasticsearchRepository<ResourceDocument, String> {
    ...
    @Query(
            "{\"bool\": {\"must\": [{\"multi_match\": {\"query\": \"?0\", \"fields\": [\"name\","
                    + " \"description\"]}},{\"term\": {\"tenantId\": \"?1\"}}]}}")
    ...
    List<ResourceDocument> findByTypeAndIsAvailableAndTenantId(
            String type, boolean isAvailable, String tenantId);
